...
class FormularioActualizarValidator extends InputFilter{
            ...
            $nombre=array(
                ...
                'validators'=>array(
                    array(
                        ...
                        'options' => array(
                            'messages' => array(
                                \Zend\Validator\NotEmpty::IS_EMPTY => 'La ciudad es obligatoria',
                            ),
                        ),
                    ),
                    array (
            ...
            $nombre=array(
                ...
                'validators'=>array(
                    array(
                        ...
                        'options' => array(
                            'messages' => array(
                                \Zend\Validator\NotEmpty::IS_EMPTY => utf8_encode('La dirección es obligatoria'),
                            ),
                        ),
                    ),
                    array (
                        ...
                        'options' => array(
                            ...
                            'max' => '1000',
                            'messages' => array(
                                \Zend\Validator\StringLength::INVALID=> utf8_encode('La dirección es invalida'),
                                \Zend\Validator\StringLength::TOO_SHORT=>utf8_encode('La dirección debe tener una logitud minima de 3 caracteres'),
                    ...
                    array (
                        ...
                        'options' => array(
                            ...
                            'allowWhiteSpace'=>true,
                            'messages' => array(
                                I18nValidator\Alnum::INVALID=>utf8_encode('La dirección solo pueden esta conformada por letras y numeros'),
                                I18nValidator\Alnum::NOT_ALNUM=>utf8_encode('La dirección solo puede estar conformada por letras y numeros'),
                                I18nValidator\Alnum::STRING_EMPTY=>utf8_encode('La dirección no puede estar vacia.'),
                            ),
                        ),
            ...
            $telefono=array(
                ...
                'validators'=>array(
                    array(
                        ...
                        'options' => array(
                            'messages' => array(
                                \Zend\Validator\NotEmpty::IS_EMPTY => utf8_encode('El teléfono es obligatorio'),
                            ),
                        ),
                    ),
                    array(
                    ...
                    'options' => array(
                        'messages' => array(
                            \Zend\Validator\Digits::INVALID => utf8_encode('El teléfono debe contener solo digitos'),
                            \Zend\Validator\Digits::NOT_DIGITS =>utf8_encode('El teléfono debe contener solo digitos'),
                        ),
                    ),
                ),
                    array (
                        ...
                        'options' => array(
                            ...
                            'max' => '15',
                            'messages' => array(
                                \Zend\Validator\StringLength::INVALID=>utf8_encode('El teléfono esta mal'),
                                \Zend\Validator\StringLength::TOO_SHORT=>utf8_encode('El teléfono debe tener al menos 6 digitos'),
                                \Zend\Validator\StringLength::TOO_LONG=>utf8_encode('El teléfono  debe ser de maximo de 15 digitos'),
                            ),
                        ),
                    ...
                    array (
                        ...
                        'options' => array(
                            ...
                            'messages' => array(
                                \Zend\Validator\Regex::INVALID=>utf8_encode('El teléfono no es valido'),
                                \Zend\Validator\Regex::NOT_MATCH=>utf8_encode('El teléfono no es valido'),
                    ...
                    array (
                        ...
                        'options' => array(
                            ...
                            'messages' => array(
                                ...
                                \Zend\Validator\StringLength::TOO_SHORT=>'El celular debe tener al menos 8 digitos',
                                \Zend\Validator\StringLength::TOO_LONG=>'El celular debe ser de maximo de 12 digitos',
                            ),
                        ),
